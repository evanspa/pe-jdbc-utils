...
[![Build Status](https://travis-ci.org/evanspa/pe-jdbc-utils.svg)](https://travis-ci.org/evanspa/pe-jdbc-utils)
...
* [API Docs](http://evanspa.github.com/pe-jdbc-utils)

## Installation

pe-jdbc-utils is available from Clojars.  Add the following dependency to your
`project.clj` file:

```
[pe-jdbc-utils "0.0.17"]
```
